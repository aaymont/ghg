...
| **Idle / driving (API only)** | [API_IDLE_DRIVING.md](references/API_IDLE_DRIVING.md) | Trip-based drive & idle without OData; optional `GEOTAB_ALT_DATABASE` probe |
...
| [API_IDLE_DRIVING.md](references/API_IDLE_DRIVING.md) | Idling & driving from Trip API when Data Connector and idling exceptions are unavailable |
